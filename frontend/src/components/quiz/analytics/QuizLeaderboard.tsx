...
function RankBadge({ rank }: { rank: number }): React.JSX.Element {
  if (rank === 1) {
    return (
      <span
        className="bg-warning/15 text-warning flex size-7 shrink-0 items-center justify-center rounded-pill"
  ...
  return (
    <span
      className={cn(
        'text-badge flex size-7 shrink-0 items-center justify-center rounded-pill font-semibold',
